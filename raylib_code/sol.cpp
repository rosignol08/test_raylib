...
// Constructeur
Plante::Plante(string n, int h_min, int h_max, int t_min, int t_max, int inf_h, int inf_temp, float t, float ta_max, float pente_min, float pente_max, int a,bool morte, int age_max, Model mod)
