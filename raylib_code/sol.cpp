...
// Constructeur
Plante::Plante(string n, int h_min, int h_max, int t_min, int t_max, int inf_h, int inf_temp, float t, float ta_max, float pen, int a,bool morte, int age_max, Model mod)
    : nom(n), humidite_min(h_min), humidite_max(h_max), temperature_min(t_min), temperature_max(t_max), influence_humidite(inf_h), influence_temperature(inf_temp),
      taille(t), taille_max(ta_max), pente_max(pen), age(a), morte(morte), age_max(age_max), model(mod) {
